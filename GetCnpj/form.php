...
<body>
<!--Adcionando css só para não ficar muito feio-->
<link rel="stylesheet" type="text/css" href="../aula/_css/estilo.css"> 
<!--Importando Script Jquery-->
<script type="text/javascript" src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
<!--Formulário-->
<div>
  <h4>cnpj teste: 28569926000111</h4>
<form id="post" action="cnpj.php" method="GET">
  <label for="cnpj">CNPJ</label>
  <input id="cnpj" name="cnpj" required type="text">
  <br/>
